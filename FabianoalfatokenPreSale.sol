...
import "./Fabianoalfatoken.sol";

contract FabianoalfatokenPreSale {
    Fabianoalfatoken public token;
    ...
    function FabianoalfatokenPreSale(
        Fabianoalfatoken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = Fabianoalfatoken(_token);
